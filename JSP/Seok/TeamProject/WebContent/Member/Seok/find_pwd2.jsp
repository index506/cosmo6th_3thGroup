    ...
    <script>
        ...
        function confirmNum(){
            if($('.confirmNum').val()==1234)
                window.location.href="reset_pwd.html";
            };
...
<div id="main_header_wrap">
    ...
    <div class="pwd2_wrap">
        ...
        <div class="certi_box">
            ...
            <input type="email" placeholder="이메일을 입력해주세요. "><button onclick="certiNum();">인증번호 보내기</button></br>

            <input type="text" class="confirmNum"><button onclick="confirmNum();">인증번호 확인</button>
