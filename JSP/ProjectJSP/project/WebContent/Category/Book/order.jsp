...
<script src="${contextPath}/js/order.js"></script>
<script>
        $(function () {
                    ...
                    <tr>
                        <td>
                            <div class="productBox">
                                <img src="${contextPath}/images/img_book_01.jpg" alt="상품이미지" class="productImg"/><br>
            ...
            <div id="innerWrap5">
                <div class="approvalBox">
                    ...
                    <div class="approvalContents">
                        <span>내용닫기</span> <img src="${contextPath}/images/btn_up.gif" alt="내용보기" />
                    </div>
                </div>
                <div class="slide">
                    <div class="approvalBox">
