...
<head>
    ...
    <!--개인 css, js-->
    <link rel="stylesheet" href="${contextPath}/Member/Seok/css/login.css">
...
<body>
    ...
    <div id="main_header_wrap">
        ...
        <header id="main_header">
            <!--main_logo-->
            <h1 id="main_logo">
                <a href="../../index.html" title="title"><img src="${contextPath}/images/main-logo.png" alt="title"></a>
            </h1>
            <!--//main_logo-->
            <!--main_gnb-->
            <div id="main_gnb">
    ...
    <div class="loginWrap" >
    <div align="center">
        <a href="javascript:window.location.reload();"><img src="${contextPath}/Member/Seok/images/login_logo.png" title="mainPic"></a>
    </div>
