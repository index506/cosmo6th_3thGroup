...
<body>
    ...
    <section>
        ...
        <div id="AT" class="content">
            <img src="${contextPath}/images/image_support/tit21.gif"/>
            <article>
...
제1조 목 적
본 약관은 ㈜통번역시험위원회(이하 '회사')가 제공하는 itt.or.kr 서비스(이하 '서비스')의 이용조건 및 절차에 관해 규정함을 목적으로 합니다.
