...
public class LogDAO {
	...
	public ArrayList<LogVO> selectTestListById(String id, int tpage) {
		...
		String sql = "select * from test_log where id=? order by log_date desc";
		int abspage=1;
		try {
			conn = dataFactory.getConnection();
	...
	public String pageNumber(String id, int tpage) {
		...
		if(page_count > end_page) {
			str+="<a href='../mypage/mypage.do?tpage="+(end_page-1)+"'>&lt;</a>&nbsp;&nbsp;";
			str+="<a href='../mypage/mypage.do?tpage="+page_count+"'>&lt;</a>&nbsp;&nbsp;";
		}
