...
<body>
	...
	<section>
		...
		<div class="board_wrap">
			...
			<!-- //board_title -->
			<!-- board_search -->
			<form name="frm_search" class="board_search" action="${contextPath}/board/noticeList.do">
				<span> 
					<c:choose>
								...
								<tr>
									...
									<td>
										<c:if test="${not empty postVO.fileName && postVO.fileName!='null' }">
					        				<a href="${contextPath}/download.do?board_category=${board_category}&num=${postVO.num}&downFileName=${postVO.fileName}">
					        					<img height="12.5px" src="../Category/Board/images/icon_file.png">
					        				</a>
					        			</c:if>
				        			</td>
							</c:forEach>
